...
public class SolveLocal {
    ...
    public static void grasp () {
        ...
        newSolution.setFitness(ObjectiveFunction.calculate_fitness(newSolution));

        main.finalSolution.setSolution(Routes.generate_random_solution());
        main.finalSolution.setFitness(ObjectiveFunction.calculate_fitness(main.finalSolution));
